...
import com.cloudframe.app.dto.trdpb002.Trdpb002Ctx.*;
import com.cloudframe.app.dto.trdpb002.Trdpb002Ctx;
...
//  cobolCode::DISPLAY X'E3D9C460C3E4D9D9C5D5C3E8404040404040404040407E' TRD-CURRENCY
//  DISPLAY X'E3D9C460C3E4D9D9C5D5C3E8404040404040404040407E' TRD-CURRENCY
              logger.info("X'E3D9C460C3E4D9D9C5D5C3E8404040404040404040407E'{}", new String(methodOut.getTrdCurrency())); 
//  cobolCode::DISPLAY X'E3D9C460E2C5D3D3C5D960E2C5C360C1C3C360D5E4D47E' TRD-SELLER-SEC-ACC-NUM
//  DISPLAY X'E3D9C460E2C5D3D3C5D960E2C5C360C1C3C360D5E4D47E' TRD-SELLER-SEC-ACC-NUM
              logger.info("X'E3D9C460E2C5D3D3C5D960E2C5C360C1C3C360D5E4D47E'{}", String.valueOf(methodOut.getTrdSellerSecAccNum())); 
//  cobolCode::DISPLAY X'E3D9C460C6C9C7C940404040404040404040404040407E' TRD-FIGI
//  DISPLAY X'E3D9C460C6C9C7C940404040404040404040404040407E' TRD-FIGI
              logger.info("X'E3D9C460C6C9C7C940404040404040404040404040407E'{}", new String(methodOut.getTrdFigi())); 
          }
//  cobolCode::ELSE
//  ELSE
          else { 
...
//  DISPLAY X'E3D9C460C3E4D9D9C5D5C3E8404040404040404040407E' TRD-CURRENCY
              logger.info("X'E3D9C460C3E4D9D9C5D5C3E8404040404040404040407E'{}", new String(methodOut.getTrdCurrency())); 
//  cobolCode::DISPLAY X'E3D9C460C2E4E8C5D960E2C5C360C1C3C360D5E4D4407E' TRD-BUYER-SEC-ACC-NUM
//  DISPLAY X'E3D9C460C2E4E8C5D960E2C5C360C1C3C360D5E4D4407E' TRD-BUYER-SEC-ACC-NUM
              logger.info("X'E3D9C460C2E4E8C5D960E2C5C360C1C3C360D5E4D4407E'{}", String.valueOf(methodOut.getTrdBuyerSecAccNum())); 
//  cobolCode::DISPLAY X'E3D9C460C6C9C7C940404040404040404040404040407E' TRD-FIGI
//  DISPLAY X'E3D9C460C6C9C7C940404040404040404040404040407E' TRD-FIGI
              logger.info("X'E3D9C460C6C9C7C940404040404040404040404040407E'{}", new String(methodOut.getTrdFigi())); 
          }
...
//  cobolCode::DISPLAY X'D7D6E260C3E4D9D9C5D5C3E84040407E40' POS-CURRENCY
//  DISPLAY X'D7D6E260C3E4D9D9C5D5C3E84040407E40' POS-CURRENCY
              logger.info("X'D7D6E260C3E4D9D9C5D5C3E84040407E40'{}", new String(methodOut.getPosCurrency())); 
//  cobolCode::DISPLAY X'D7D6E260E2C1C360D5E4D4C2C5D9407E40' POS-SAC-NUMBER
//  DISPLAY X'D7D6E260E2C1C360D5E4D4C2C5D9407E40' POS-SAC-NUMBER
              logger.info("X'D7D6E260E2C1C360D5E4D4C2C5D9407E40'{}", String.valueOf(methodOut.getPosSacNumber())); 
//  cobolCode::DISPLAY X'D7D6E260C6C9C7C9404040404040407E40' POS-FIGI
//  DISPLAY X'D7D6E260C6C9C7C9404040404040407E40' POS-FIGI
              logger.info("X'D7D6E260C6C9C7C9404040404040407E40'{}", new String(methodOut.getPosFigi())); 
