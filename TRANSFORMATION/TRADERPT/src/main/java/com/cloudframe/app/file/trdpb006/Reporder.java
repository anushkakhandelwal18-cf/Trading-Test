package com.cloudframe.app.file.trdpb006;
...
import com.cloudframe.app.file.records.trdpb006.*;

@Component("trdpb006_reporder")
public class Reporder extends CFFile {

	private Logger logger = LoggerFactory.getLogger(Reporder.class);
	
	@Value("${TRDPB006.Reporder:REPORDER}")
    ...
    **/
	@Value("${TRDPB006.ReporderCharSet:cp1047}")
	private String charSet;
	
	@Value("${TRDPB006.ReporderCRLFflag:no}")
	private String crlfFlag;

	public String getReporderCharSet() {
		return charSet;
	}
	
	public String getReporderCrlfFlag() {
		return crlfFlag;
	}
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during Reporder Write: {}",e.getMessage() ); 		}
	}
