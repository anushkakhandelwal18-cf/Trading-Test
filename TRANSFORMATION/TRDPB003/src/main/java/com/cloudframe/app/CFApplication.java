...
/**
 * The Trdpb003 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpb003 trdpb003 = (Trdpb003) context.getBean("trdpb003");
				...
				trdpb003.setParameter(new GlobalExecutorCtx().getContext(Trdpb003Ctx.class),inputValue);
