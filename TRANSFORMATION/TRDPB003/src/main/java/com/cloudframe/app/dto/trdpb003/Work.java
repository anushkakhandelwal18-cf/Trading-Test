package com.cloudframe.app.dto.trdpb003;

/**
*  The class Work is used to handle fields declared in it
*  @author CloudFrame Inc.
*  created on 2024-12-02 at 13:22. using version 5.0.0.161
**/


import com.cloudframe.app.dto.serialize.trdpb003.*;
...
public class Work extends WorkSerialized { 
   ...
   public void setCrDbSwtich(char[] value) {
	...
	char[] creditSeller88Value = "D".toCharArray();
	/**
   ...
   public boolean isCreditSeller() throws CFException {
      return (  compareChars( getCrDbSwtich() , creditSeller88Value)  == 0  );
   }
	...
	*  set values "D"
	*/
   	public void setCreditSellerTrue() {  			
    	setCrDbSwtich( creditSeller88Value);
   	}
	char[] debitBuyer88Value = "C".toCharArray();
	/**
	 *	Test condition "C" for isDebitBuyer()
	 *	@return  Returns true if isDebitBuyer() is "C"
	 */
   public boolean isDebitBuyer() throws CFException {
      return (  compareChars( getCrDbSwtich() , debitBuyer88Value)  == 0  );
   }
	...
	*  set values "C"
	*/
   	public void setDebitBuyerTrue() {  			
    	setCrDbSwtich( debitBuyer88Value);
   	}
	/**
