...
/**
 * The D529351u application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		D529351u d529351u = (D529351u) context.getBean("d529351u");
				...
				d529351u.setParameter(new GlobalExecutorCtx().getContext(D529351uCtx.class),inputValue,inputValue1);
