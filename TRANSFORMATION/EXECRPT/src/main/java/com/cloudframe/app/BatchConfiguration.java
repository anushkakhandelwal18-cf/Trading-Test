...
public class BatchConfiguration {
    ...
    private static final String JOBNAME = "EXECRPT";
    
    /* Driver Programs used in steps */  
    private static final String TRDPB004_BEAN = "trdpb004";
    ...
    /*
     * STEP01 TRDPB004 starts here
     * Member Info:
     *   DSN SYSTEM (DBCG)
     *   RUN PROGRAM(TRDPB004) -
     *   PLAN   (CLFRPLAN)
     *   END
     *   DSN SYSTEM (DBCG)
     *   RUN PROGRAM(TRDPB004) -
    ...
    public Step step01(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Trdpb004)cfStepHandler.initAndGetProcessBean(STEP01_STEP,TRDPB004_BEAN)).process(new GlobalExecutorCtx().getContext("TRDPB004"));
...
cfStepHandler.setAbendCode(cfe);
 		    	  		...
 		    	  		rcStatus+=rc;
 		    	   		cfStepHandler.postStepExecution(STEP01_STEP, rc ,TRDPB004_BEAN);
                      } 
