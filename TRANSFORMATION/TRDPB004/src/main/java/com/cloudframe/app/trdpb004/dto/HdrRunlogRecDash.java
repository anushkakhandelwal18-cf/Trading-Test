	...
	**/
    public HdrRunlogRecDash() {
       ...
       replaceValue( // serialize and save the value
             getString(new byte[] {(byte)0x4E,(byte)0x60}).toCharArray()
             , getStartOffset() + 0
             ,2
             );
       replaceValue( // serialize and save the value
             getString(new byte[] {(byte)0x60,(byte)0x4E,(byte)0x60}).toCharArray()
             , getStartOffset() + 14
             ,3
             );
       replaceValue( // serialize and save the value
       ...
       replaceValue( // serialize and save the value
             getString(new byte[] {(byte)0x60,(byte)0x4E,(byte)0x40}).toCharArray()
             , getStartOffset() + 83
             ,3
             );
    }
