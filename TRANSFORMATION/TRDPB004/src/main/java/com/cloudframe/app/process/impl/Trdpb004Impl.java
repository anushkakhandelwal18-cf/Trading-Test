...
//  cobolCode::MOVE ALL X'60' TO FILLER1 OF HDR-RUNLOG-REC-DASH FILLER2 OF HDR-RUNLOG-REC-DASH FILLER3 OF HDR-RUNLOG-REC-DASH FILLER4 OF HDR-RUNLOG-REC-DASH FILLER1 OF HDR-EXCPTION-REC-DASH FILLER2 OF HDR-EXCPTION-REC-DASH FILLER1 OF HDR-SUMMARY-REC-DASH FILLER2 OF HDR-SUMMARY-REC-DASH FILLER3 OF HDR-SUMMARY-REC-DASH FILLER4 OF HDR-SUMMARY-REC-DASH FILLER5 OF HDR-SUMMARY-REC-DASH FILLER6 OF HDR-SUMMARY-REC-DASH FILLER7 OF HDR-SUMMARY-REC-DASH FILLER8 OF HDR-SUMMARY-REC-DASH FILLER9 OF HDR-SUMMARY-REC-DASH
//  MOVE ALL X'60' TO FILLER1 OF HDR-RUNLOG-REC-DASH FILLER2 OF HDR-RUNLOG-REC-DASH FILLER3 OF HDR-RUNLOG-REC-DASH FILLER4 OF HDR-RUNLOG-REC-DASH FILLER1 OF HDR-EXCPTION-REC-DASH FILLER2 OF HDR-EXCPTION-REC-DASH FILLER1 OF HDR-SUMMARY-REC-DASH FILLER2 OF HDR-SUMMARY-REC-DASH FILLER3 OF HDR-SUMMARY-REC-DASH FILLER4 OF HDR-SUMMARY-REC-DASH FILLER5 OF HDR-SUMMARY-REC-DASH FILLER6 OF HDR-SUMMARY-REC-DASH FILLER7 OF HDR-SUMMARY-REC-DASH FILLER8 OF HDR-SUMMARY-REC-DASH FILLER9 OF HDR-SUMMARY-REC-DASH
          methodOut.setFiller1(CONSTANTS.HEX_60);
          methodOut.setFiller2(CONSTANTS.HEX_60);
          methodOut.setFiller3(CONSTANTS.HEX_60);
          methodOut.setFiller4(CONSTANTS.HEX_60);
          methodOut.setFiller101(CONSTANTS.HEX_60);
          methodOut.setFiller201(CONSTANTS.HEX_60);
          methodOut.setFiller102(CONSTANTS.HEX_60);
          methodOut.setFiller202(CONSTANTS.HEX_60);
          methodOut.setFiller301(CONSTANTS.HEX_60);
          methodOut.setFiller401(CONSTANTS.HEX_60);
          methodOut.setFiller5(CONSTANTS.HEX_60);
          methodOut.setFiller6(CONSTANTS.HEX_60);
          methodOut.setFiller7(CONSTANTS.HEX_60);
          methodOut.setFiller8(CONSTANTS.HEX_60);
          methodOut.setFiller9(CONSTANTS.HEX_60);
          ;
      ...
      * processException 
      *   This method is derived from 
  *   COBOL Paragraph - 1000-PROCESS-EXCEPTION COBOL Cyclomatic complexity - 28
      * Input  :  
...
//  cobolCode::STRING X'D697859540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'D697859540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
...
//  IF EXCPTION-FILE-STATUS NOT = 0
          if (	( methodOut.getExcptionFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  IF EXCPTION-FILE-STATUS NOT = 0
              if (	( methodOut.getExcptionFileStatus() != 0 )) { 
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
...
//  IF EXCPTION-FILE-STATUS NOT = 0
          if (	( methodOut.getExcptionFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'C39396A28540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'C39396A28540C5E7C3C5D7E3C9D6D540C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' EXCPTION-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  PERFORM 9000-REPORT-EXCEPTION THRU 9000-EXIT
      ...
      * processTimings 
      *   This method is derived from 
  *   COBOL Paragraph - 2000-PROCESS-TIMINGS COBOL Cyclomatic complexity - 26
      * Input  :  
...
//  IF RUNLOG-FILE-STATUS NOT = 0
          if (	( methodOut.getRunlogFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'D697859540D9E4D5D3D6C740C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'D697859540D9E4D5D3D6C740C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  IF RUNLOG-FILE-STATUS NOT = 0
          if (	( methodOut.getRunlogFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.HEX_2);
                 charArray.add(String.valueOf(methodOut.getRunlogFileStatusString()).toCharArray());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1));
...
//  IF RUNLOG-FILE-STATUS NOT = 0
          if (	( methodOut.getRunlogFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'C39396A28540D9E4D5D3D6C740C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'C39396A28540D9E4D5D3D6C740C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' RUNLOG-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  PERFORM 9000-REPORT-EXCEPTION THRU 9000-EXIT
      ...
      * processSummaryRpt 
      *   This method is derived from 
  *   COBOL Paragraph - 3000-PROCESS-SUMMARY-RPT COBOL Cyclomatic complexity - 26
      * Input  :  
...
//  IF SUMMARY-FILE-STATUS NOT = 0
          if (	( methodOut.getSummaryFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'D697859540E2E4D4D4C1D9E840C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'D697859540E2E4D4D4C1D9E840C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  IF SUMMARY-FILE-STATUS NOT = 0
          if (	( methodOut.getSummaryFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E69989A38540C5E7C3C5D7E3C9D6D540C8858184859940868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.HEX_2);
                 charArray.add(String.valueOf(methodOut.getSummaryFileStatusString()).toCharArray());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1));
...
//  IF SUMMARY-FILE-STATUS NOT = 0
          if (	( methodOut.getSummaryFileStatus() != 0 )) { 
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'C39396A28540E2E4D4D4C1D9E840C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'C39396A28540E2E4D4D4C1D9E840C6C9D3C540868189938584407A40C689938560E2A381A3A4A2407E40' SUMMARY-FILE-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
