...
import com.cloudframe.app.dto.trdpb001.Trdpb001Ctx.*;
import com.cloudframe.app.dto.trdpb001.Trdpb001Ctx;
import com.cloudframe.app.service.Trdpb001;
...
import com.cloudframe.app.business.Trdpb002;
import com.cloudframe.app.business.*;
import com.cloudframe.app.service.*;
import com.cloudframe.app.business.Trdpb003;
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E28583A49989A3A840C2969692899587A240C68189938584' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E28583A49989A3A840C2969692899587A240C68189938584' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40D4969585A840C2969692899587A240C68189938584' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40D4969585A840C2969692899587A240C68189938584' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
