package com.cloudframe.app.file.utility.sort;
  ...
  @Component("Gdghfix336Step001SortIn")
  @JobScope
  public class Gdghfix336Step001SortIn extends CFFile {
  	private Logger logger = LoggerFactory.getLogger(Gdghfix336Step001SortIn.class);
  	@Value("${Gdghfix336Step001SortIn:CLOUDFRM.SF.P3GX.PRSF2130.SORT.IN}")
  	...
  	@Value("#{'${Gdghfix336Step001SortInRecordType:${Gdghfix336Step001SortInRecordType:FB}}'}")
  	private String recordType;
  
  	@Value("#{'${Gdghfix336Step001SortInRecordLen:${Gdghfix336Step001SortInRecordLen:80}}'}")
  	...
  	public void read() {
  		try {
  			...
  			logger.error("Error during Gdghfix336Step001SortIn Read: {}",e.getMessage()); 
  		}
  	}
