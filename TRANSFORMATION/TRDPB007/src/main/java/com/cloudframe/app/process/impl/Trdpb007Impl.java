...
//  CALL 'MQCONN' USING WS-MQM , WS-HCONN , WS-COMPCODE , WS-REASON
          // CALL 'MQCONN' USING WS-MQM , WS-HCONN , WS-COMPCODE , WS-REASON
...
//  MOVE WS-COMPCODE TO WS-COMPCODE-EDIT
//  FORMAT_287469588 = "---------9"
...
//  MOVE WS-REASON TO WS-REASON-EDIT
//  FORMAT_287469588 = "---------9"
...
//  MOVE 'TRADING.QUEUE' TO MQOD-OBJECTNAME
...
//  MOVE SPACES TO MQMD-REPLYTOQ , MQMD-REPLYTOQMGR
...
//  MOVE WS-TRADING-PARMS TO WS-PUT-BUFFER
...
//  MOVE LENGTH OF CSQ4BIIM-MSG TO WS-BUFFLEN
...
//  CALL 'MQPUT1' USING WS-HCONN , MQOD , MQMD , MQPMO , WS-BUFFLEN , WS-PUT-BUFFER , WS-COMPCODE , WS-REASON
          // CALL 'MQPUT1' USING WS-HCONN , MQOD , MQMD , MQPMO , WS-BUFFLEN , WS-PUT-BUFFER , WS-COMPCODE , WS-REASON
...
//  DISPLAY 'Program MQWRITE, Write Failed:'
...
//  DISPLAY 'Successfull write of: ' WS-PUT-BUFFER
...
//  DISPLAY 'Program MQDISC, Disconnect Failed:'
