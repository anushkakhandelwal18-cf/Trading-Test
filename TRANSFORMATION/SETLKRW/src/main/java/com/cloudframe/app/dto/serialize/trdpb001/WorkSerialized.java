package com.cloudframe.app.dto.serialize.trdpb001;
...
public class WorkSerialized  extends Field { 
	...
	**/
	...
	protected void init(int begin) {
	   ...
	   /*  set the offset/position of each field when this object is serialized as String */
             ...
             beginTradeid = getStartOffset() + 4;	// set offset for serialization
	   ...
	   /*  end of offset */
         ...
         int localTradeCountCounter = -1;
         public boolean isTradeCountModified() {
            int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
            boolean hasModified = localTradeCountCounter != sharedCounter;
            localTradeCountCounter = sharedCounter; return hasModified; 
         }
       
      
   protected int checkTradeCountMaxLimit(long number) {
   ...
   protected long checkTradeidMaxLimit(long number) {
	 ...
	 */ 
     ...
     int localSacBookingCounter = -1;
     public boolean isSacBookingModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localSacBookingCounter != sharedCounter;
         localSacBookingCounter = sharedCounter; return hasModified;
     }

   protected char[] checkSacBookingConstraints(char[] value) {
   			return super.checkConstraints(value , 8 ,false, false);
   }
     int localMacBookingCounter = -1;
     public boolean isMacBookingModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localMacBookingCounter != sharedCounter;
         localMacBookingCounter = sharedCounter; return hasModified;
     }

   protected char[] checkMacBookingConstraints(char[] value) {
   			return super.checkConstraints(value , 8 ,false, false);
   }
   ...
   protected char[] checkSummaryDebitCreditSwConstraints(char[] value) {
     ...
     int localSettlementSwitchCounter = -1;
     public boolean isSettlementSwitchModified() {
         int sharedCounter = shareString.getSerializedField().getModifiedCounter(); 
         boolean hasModified = localSettlementSwitchCounter != sharedCounter;
         localSettlementSwitchCounter = sharedCounter; return hasModified;
     }

   protected char[] checkSettlementSwitchConstraints(char[] value) {
   			return super.checkConstraints(value , 1 ,false, false);
   }
