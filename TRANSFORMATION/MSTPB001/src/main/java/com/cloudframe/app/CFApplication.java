...
/**
 * The Mstpb001 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mstpb001 mstpb001 = (Mstpb001) context.getBean("mstpb001");
				...
				mstpb001.setParameter(new GlobalExecutorCtx().getContext(Mstpb001Ctx.class),inputValue);
