...
/**
 * The Trdpb006 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpb006 trdpb006 = (Trdpb006) context.getBean("trdpb006");
        	    trdpb006.process(new GlobalExecutorCtx().getContext(Trdpb006Ctx.class)); /*  Trdpb006 requires no input parameters  */
