...
//  FETCH CLIENT_ORDERS INTO ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?
          trdpb006Repository.fetchClientOrdersTrdpb006(programCtx.getClientOrdersResultSet(),methodOut.getDcltbtrdcus(),methodOut.getDcltbtrdsec(),methodOut.getDcltbtrdord(),methodOut.getWork(),programCtx.getSqlca());
