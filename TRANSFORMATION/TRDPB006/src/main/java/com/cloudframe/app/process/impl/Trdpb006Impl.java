...
//  FETCH CLIENT_ORDERS INTO ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?
          trdpb006Repository.fetchClientOrdersTrdpb006(programCtx.getClientOrdersResultSet(),methodOut.getWork(),programCtx.getSqlca(),methodOut.getDcltbtrdcus(),methodOut.getDcltbtrdsec(),methodOut.getDcltbtrdord());
