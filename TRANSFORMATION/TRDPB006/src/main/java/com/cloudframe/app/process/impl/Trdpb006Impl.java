...
//  cobolCode::FETCH CLIENT_ORDERS INTO ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?
          trdpb006Repository.fetchClientOrdersTrdpb006(programCtx.getClientOrdersResultSet(),methodOut.getDcltbtrdcus(),methodOut.getDcltbtrdsec(),methodOut.getWork(),programCtx.getSqlca(),methodOut.getDcltbtrdord());
