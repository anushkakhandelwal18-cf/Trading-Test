...
*/
  ...
  import com.cloudframe.app.trdpb000.Trdpb000Ctx.*;
  import com.cloudframe.app.trdpb000.Trdpb000Ctx;
  import com.cloudframe.app.process.Trdpb000;
  ...
  import com.cloudframe.app.process.Mstpb001;
  import com.cloudframe.app.process.*;
  import com.cloudframe.app.process.Mstpb002;
  import com.cloudframe.app.process.Trdpbexc;
  import java.math.BigDecimal;
  import java.math.RoundingMode;
  import com.cloudframe.app.dto.ProgramContext;
  import com.cloudframe.app.trdpb000.dto.*;
  import com.cloudframe.app.trdpb000.dto.Sqlca;
  import com.cloudframe.app.trdpb000.dto.SettlmentQueueTable;
  import com.cloudframe.app.trdpb000.dto.Parm;
  import com.cloudframe.app.trdpb000.dto.CustomerIo;
  import com.cloudframe.app.trdpb000.dto.TrdOrderPair;
  import com.cloudframe.app.trdpb000.dto.Dcltbtrdmac;
  import com.cloudframe.app.trdpb000.dto.Dcltbtrdsum;
  import com.cloudframe.app.trdpb000.dto.CustomerSummaryRec;
  import com.cloudframe.app.trdpb000.dto.ExceptionRecordLenGroup;
  import com.cloudframe.app.trdpb000.dto.SecurityIo;
  import com.cloudframe.app.trdpb000.dto.Dcltbtrdsac;
  import com.cloudframe.app.trdpb000.dto.Dcltbtrdlog;
  import com.cloudframe.app.trdpb000.dto.ExceptionRecord;
  import com.cloudframe.app.trdpb000.dto.Dcltbtrdord;
  import com.cloudframe.app.trdpb000.dto.Work;
...
//  cobolCode::STRING WS-CURRDATE (1 : 4) X'60' WS-CURRDATE (5 : 2) X'60' WS-CURRDATE (7 : 2) ' ' WS-CURRTIME (1 : 2) ':' WS-CURRTIME (3 : 2) ':' WS-CURRTIME (5 : 2) DELIMITED BY SIZE INTO LOG-START-TS END-STRING
//  STRING WS-CURRDATE (1 : 4) X'60' WS-CURRDATE (5 : 2) X'60' WS-CURRDATE (7 : 2) ' ' WS-CURRTIME (1 : 2) ':' WS-CURRTIME (3 : 2) ':' WS-CURRTIME (5 : 2) DELIMITED BY SIZE INTO LOG-START-TS END-STRING
          charArray = new ArrayList<char[]>();
             charArray.add(substring(methodOut.getCurrdate(),0,4));
             charArray.add(CONSTANTS.HEX_60);
...
//  cobolCode::STRING WS-CURRDATE (1 : 4) X'60' WS-CURRDATE (5 : 2) X'60' WS-CURRDATE (7 : 2) ' ' WS-CURRTIME (1 : 2) ':' WS-CURRTIME (3 : 2) ':' WS-CURRTIME (5 : 2) DELIMITED BY SIZE INTO LOG-END-TS END-STRING
//  STRING WS-CURRDATE (1 : 4) X'60' WS-CURRDATE (5 : 2) X'60' WS-CURRDATE (7 : 2) ' ' WS-CURRTIME (1 : 2) ':' WS-CURRTIME (3 : 2) ':' WS-CURRTIME (5 : 2) DELIMITED BY SIZE INTO LOG-END-TS END-STRING
          charArray = new ArrayList<char[]>();
             charArray.add(substring(methodOut.getCurrdate(),0,4));
             charArray.add(CONSTANTS.HEX_60);
             charArray.add(substring(methodOut.getCurrdate(),4,6));
...
//  SET DATA-EXCEPTION TO TRUE
                  ...
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E289848540D69984859940' X'E2A381A3A4A240C995A581938984406040D69984859940E2A381A3A4A2407E40' WS-ORDER-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E289848540D69984859940' X'E2A381A3A4A240C995A581938984406040D69984859940E2A381A3A4A2407E40' WS-ORDER-STATUS DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E289848540D69984859940' 'Not Found ' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E289848540D69984859940' 'Not Found ' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E2859393859940D69984859940E285938583A340C68189938584406040E2D8D3C3D6C4C5407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E2859393859940D69984859940E285938583A340C68189938584406040E2D8D3C3D6C4C5407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C3A4A2A39694859940' ORD-CUSTOMER-ID ' Not found' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C3A4A2A39694859940' ORD-CUSTOMER-ID ' Not found' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C3A4A2A39694859940' ORD-CUSTOMER-ID ' Not Active' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C3A4A2A39694859940' ORD-CUSTOMER-ID ' Not Active' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2C5C3E4D9C9E3E840' ORD-FIGI ' Not found' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2C5C3E4D9C9E3E840' ORD-FIGI ' Not found' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
                 charArray.add(CONSTANTS.HEX_5);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2C5C3E4D9C9E3E840' ORD-FIGI ' Not Active' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2C5C3E4D9C9E3E840' ORD-FIGI ' Not Active' DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodOut.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET DATA-EXCEPTION TO TRUE
                  ...
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940E28583A49989A3A840C1838396A495A3' X'40D596A3408183A389A585406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940E28583A49989A3A840C1838396A495A3' X'40D596A3408183A389A585406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
                     charArray.add(CONSTANTS.LITERAL_869114500);
                     charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                     charArray.add(CONSTANTS.LITERAL_B2_CL_);
                     charArray.add(CONSTANTS.HEX_6);
                     charArray.add(CONSTANTS.HEX_7);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940E28583A49989A3A840C1838396A495A3' X'40D596A340C696A4958440406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940E28583A49989A3A840C1838396A495A3' X'40D596A340C696A4958440406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
                 charArray.add(CONSTANTS.HEX_6);
                 charArray.add(CONSTANTS.HEX_8);
                 charArray.add(methodOut.getAccDisp());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2),charArray.get(3),charArray.get(4),charArray.get(5));
              updated = updateString(methodOut.getException() ,joinCharArray);
              methodOut.setException(  (char[])updated.get("string"));
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'Buyer Security Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'Buyer Security Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_Buyer_B2_SecurityAccount);
                 charArray.add(CONSTANTS.HEX_9);
                 charArray.add(methodOut.getSqlcode_Ws());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2));
              updated = updateString(methodOut.getException() ,joinCharArray);
              methodOut.setException(  (char[])updated.get("string"));
...
//  SET DATA-EXCEPTION TO TRUE
                  ...
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E28583A49989A3A840C1838396A495A3' X'40D596A3408183A389A585406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E28583A49989A3A840C1838396A495A3' X'40D596A3408183A389A585406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
                     charArray.add(CONSTANTS.LITERAL_869114500);
                     charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                     charArray.add(CONSTANTS.LITERAL_B2_CL_);
                     charArray.add(CONSTANTS.HEX_10);
                     charArray.add(CONSTANTS.HEX_7);
                     charArray.add(methodOut.getAccDisp());
                  joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2),charArray.get(3),charArray.get(4),charArray.get(5));
                  updated = updateString(methodOut.getException() ,joinCharArray);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E28583A49989A3A840C1838396A495A3' X'40D596A340C696A4958440406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940E28583A49989A3A840C1838396A495A3' X'40D596A340C696A4958440406040E2C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'Seller Security Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'Seller Security Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  SET DATA-EXCEPTION TO TRUE
                  ...
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940D4969585A840C1838396A495A3' X'40D596A3408183A389A585406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940D4969585A840C1838396A495A3' X'40D596A3408183A389A585406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
                     charArray.add(CONSTANTS.LITERAL_869114500);
                     charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                     charArray.add(CONSTANTS.LITERAL_B2_CL_);
                     charArray.add(CONSTANTS.HEX_11);
                     charArray.add(CONSTANTS.HEX_12);
                     charArray.add(methodOut.getAccDisp());
                  joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2),charArray.get(3),charArray.get(4),charArray.get(5));
                  updated = updateString(methodOut.getException() ,joinCharArray);
                  methodOut.setException(  (char[])updated.get("string"));
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940D4969585A840C1838396A495A3' X'40D596A340C696A4958440406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40C2A4A8859940D4969585A840C1838396A495A3' X'40D596A340C696A4958440406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
                 charArray.add(CONSTANTS.HEX_11);
                 charArray.add(CONSTANTS.HEX_13);
                 charArray.add(methodOut.getAccDisp());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2),charArray.get(3),charArray.get(4),charArray.get(5));
              updated = updateString(methodOut.getException() ,joinCharArray);
              methodOut.setException(  (char[])updated.get("string"));
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'Buyer Money Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'Buyer Money Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  SET DATA-EXCEPTION TO TRUE
                  ...
                  // MOVE SPACES TO WS-EXCEPTION
                  methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940D4969585A840C1838396A495A3' X'40D596A3408183A389A585406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940D4969585A840C1838396A495A3' X'40D596A3408183A389A585406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
                  charArray = new ArrayList<char[]>();
                     charArray.add(CONSTANTS.LITERAL_869114500);
                     charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                     charArray.add(CONSTANTS.LITERAL_B2_CL_);
                     charArray.add(CONSTANTS.HEX_14);
                     charArray.add(CONSTANTS.HEX_12);
                     charArray.add(methodOut.getAccDisp());
                  joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1),charArray.get(2),charArray.get(3),charArray.get(4),charArray.get(5));
                  updated = updateString(methodOut.getException() ,joinCharArray);
...
//  SET DATA-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940D4969585A840C1838396A495A3' X'40D596A340C696A4958440406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'TradeId = ' WS-TRADEID ' : ' X'D985918583A38584406040D98581A29695407A40E2859393859940D4969585A840C1838396A495A3' X'40D596A340C696A4958440406040D4C1C340D5A4949582859940407E40' WS-ACC-DISP DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.LITERAL_869114500);
                 charArray.add(String.valueOf(methodIn.getTradeidString()).toCharArray());
                 charArray.add(CONSTANTS.LITERAL_B2_CL_);
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING 'Seller Money Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING 'Seller Money Account' X'40E285938583A340C68189938584406040E2D8D3C3D6C4C540407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
...
//  SET APPL-EXCEPTION TO TRUE
              ...
              // MOVE SPACES TO WS-EXCEPTION
              methodOut.setException(CONSTANTS.SPACE_200);
//  cobolCode::STRING X'E2A494948199A840C995A28599A361E4978481A38540C68189938584407A40E2D8D3C3D6C4C5407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
//  STRING X'E2A494948199A840C995A28599A361E4978481A38540C68189938584407A40E2D8D3C3D6C4C5407E40' WS-SQLCODE DELIMITED BY SIZE INTO WS-EXCEPTION END-STRING
              charArray = new ArrayList<char[]>();
                 charArray.add(CONSTANTS.HEX_15);
                 charArray.add(methodOut.getSqlcode_Ws());
              joinCharArray = Field.mergeArrays(charArray.get(0),charArray.get(1));
              updated = updateString(methodOut.getException() ,joinCharArray);
              methodOut.setException(  (char[])updated.get("string"));
