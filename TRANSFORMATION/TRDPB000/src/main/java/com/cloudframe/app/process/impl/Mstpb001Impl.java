...
//  MOVE LS-CUSTOMER-ID TO CUS-CUSTOMER-ID
...
//  SET 88-CUSTOMER-ACTIVE TO TRUE
...
//  STRING 'Customer Access failed. SQLCODE = ' WS-SQLCODE DELIMITED BY SIZE INTO LS-CUSTOMER-ERROR-MSG END-STRING
