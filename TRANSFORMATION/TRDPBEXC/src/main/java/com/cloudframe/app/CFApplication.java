...
/**
 * The Trdpbexc application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpbexc trdpbexc = (Trdpbexc) context.getBean("trdpbexc");
				...
				trdpbexc.setParameter(new GlobalExecutorCtx().getContext(TrdpbexcCtx.class),inputValue,inputValue1);
