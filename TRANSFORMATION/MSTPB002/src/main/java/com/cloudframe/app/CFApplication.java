...
/**
 * The Mstpb002 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Mstpb002 mstpb002 = (Mstpb002) context.getBean("mstpb002");
				...
				mstpb002.setParameter(new GlobalExecutorCtx().getContext(Mstpb002Ctx.class),inputValue);
