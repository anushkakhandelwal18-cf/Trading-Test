...
public class BatchConfiguration {
    ...
    private static final String JOBNAME = "SETLKRW";
    
    /* Driver Programs used in steps */  
    private static final String TRDPB001_BEAN = "trdpb001";
    
    private static final String COMPLETED_STATUS = "COMPLETED";
    
    /*
     * STEP01 TRDPB001 starts here
     * Member Info:
     *   DSN SYSTEM (DBCG)
     *   RUN PROGRAM(TRDPB001) -
     *   PLAN   (CLFRPLAN) -
     *   PARM('KRW 0100')
     *   END
     *   DSN SYSTEM (DBCG)
    ...
    @Value("${STEP01.TRDPB001.inputValue:'KRW 0100'}")
    private String step01Trdpb001Parm ;
    ...
    public Step step01(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
     ...
     int rc = 0;
 	   try { 
 		    	  		rc = ((Trdpb001)cfStepHandler.initAndGetProcessBean(STEP01_STEP,TRDPB001_BEAN)).setParameter(new GlobalExecutorCtx().getContext("TRDPB001"), cfStepHandler.getParm(step01Trdpb001Parm));
...
cfStepHandler.setAbendCode(cfe);
 		    	  		...
 		    	  		rcStatus+=rc;
 		    	   		cfStepHandler.postStepExecution(STEP01_STEP, rc ,TRDPB001_BEAN);
                      } 
