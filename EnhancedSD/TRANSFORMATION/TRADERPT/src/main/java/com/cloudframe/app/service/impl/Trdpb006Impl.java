...
//  cobolCode::FETCH CLIENT_ORDERS INTO ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?
          trdpb006Repository.fetchClientOrdersTrdpb006(programCtx.getClientOrdersResultSet(),methodOut.getDcltbtrdcus(),methodOut.getWork(),methodOut.getDcltbtrdord(),programCtx.getSqlca(),methodOut.getDcltbtrdsec());
